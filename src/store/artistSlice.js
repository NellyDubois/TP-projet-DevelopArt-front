...
const artistSlice = createSlice({
  ...
  reducers: {
    ...
    // reducer servant à mettre les données a jour de l'artiste pour le token et le mettre l'artiste en tant que "connecté"
    ...
    // reducer servant à déconnecté l'artiste
